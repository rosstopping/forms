...
class SeoImpact extends Model
{
    ...
    protected $fillable = ['website_id', 'content_request_id', 'content_generation_id', 'source_key', 'title', 'hypothesis', 'target_urls', 'target_queries', 'control_url', 'country', 'device', 'primary_metric', 'business_value', 'confidence', 'effort', 'evidence', 'status', 'live_at', 'confirmed_by', 'deployment_evidence', 'actual_changes', 'property_url', 'baseline', 'observations', 'last_measured_at', 'next_measurement_at', 'review_after_days', 'outcome', 'decision', 'decision_notes', 'reviewed_by', 'reviewed_at', 'measurement_error'];

    protected $attributes = ['status' => 'planned', 'primary_metric' => 'clicks', 'business_value' => 3, 'confidence' => 3, 'effort' => 3, 'review_after_days' => 28];

    protected function casts(): array
    {
        return ['target_urls' => 'array', 'target_queries' => 'array', 'evidence' => 'array', 'baseline' => 'array', 'observations' => 'array', 'live_at' => 'datetime', 'last_measured_at' => 'datetime', 'next_measurement_at' => 'datetime', 'reviewed_at' => 'datetime'];
    }
