    ...
    <div class="rounded-lg border bg-white p-6 shadow-sm">
        <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <input id="admin_membership_expires_at" name="admin_membership_expires_at" type="date" value="{{ old('admin_membership_expires_at') }}" class="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm">
