...
- Include the absolute canonical URL of every affected public page in the PR description, including new pages. Summarise the actual change and its reason for each URL. Sitewell uses these URLs to verify delivery and measure the result automatically.
