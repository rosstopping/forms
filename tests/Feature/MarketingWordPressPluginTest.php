...
it('downloads the current Sitewell WordPress plugin', function (): void {
    ...
    foreach (['sitewell-static-frontend.php', 'src/FrontendRouter.php', 'src/Plugin.php', 'src/BypassPolicy.php', 'src/DirectDelivery.php', 'src/DeliveryRules.php', 'src/UploadsDelivery.php', 'readme.txt'] as $file) {
