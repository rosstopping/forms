    ...
    Http::fake(function (Request $request) {
        return match ($request->url()) {
            ...
            default => Http::response(<<<'HTML'
                <html><head><title>Example plumbing services</title><meta name="viewport" content="width=device-width, initial-scale=1"><script type="application/ld+json">{invalid}</script></head><body><h1>Reliable plumbing</h1><img src="team.jpg"></body></html>
