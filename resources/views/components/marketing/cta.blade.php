<section class="bg-garden py-16 text-white sm:py-20">
    <div class="mx-auto grid max-w-7xl gap-8 px-5 sm:px-8 lg:grid-cols-[3fr_1fr] lg:items-end lg:px-10">
        <div>
            ...
            <h2 class="mt-4 max-w-[24ch] font-display text-4xl font-semibold tracking-tight text-balance sm:text-5xl">Ready to give every client site the care it deserves?</h2>
        </div>
