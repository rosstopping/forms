        <section class="rounded-lg border border-slate-950/10 bg-white p-5" aria-labelledby="content-preview-title">
            <p class="text-sm font-medium text-violet-700">Content workflow</p>
