...
class UpdateProspectingIndustryProfileRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'max:120', Rule::unique('prospecting_industry_profiles', 'slug')->ignore($this->route('prospecting_industry_profile'))],
