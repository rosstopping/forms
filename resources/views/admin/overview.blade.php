...
@section('content')
    <div class="space-y-6">
        <header>
            <p class="font-mono text-teal-700 text-base sm:text-sm">All websites</p>
        ...
        <section class="ui-panel ui-section" aria-labelledby="approvals-heading">
            <h2 id="approvals-heading" class="text-xl font-semibold text-slate-950">Actions to review</h2>
            <p class="mt-1 text-slate-600 text-base sm:text-sm">Open the website work to inspect changes and approve them.</p>
            <div class="mt-5 space-y-6">
                <div>
                    ...
                    <div class="mt-2 divide-y divide-slate-100">
                        ...
                        @empty
                            <p class="py-3 text-slate-500 text-base sm:text-sm">No draft changes awaiting review.</p>
                        @endforelse
                    </div>
                ...
                <div>
                    ...
                    @empty
                        <p class="py-3 text-slate-500 text-base sm:text-sm">No content pull requests awaiting review.</p>
                    @endforelse
                ...
                <div>
                    ...
                    @empty
                        <p class="py-3 text-slate-500 text-base sm:text-sm">No website fixes awaiting review.</p>
                    @endforelse
        ...
        <section id="content-queue" class="ui-panel ui-section scroll-mt-20" aria-labelledby="content-queue-heading">
