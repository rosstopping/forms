...
- Add website change monitoring for titles, descriptions, canonicals, indexing directives, headings, structured data, forms, status codes, redirects, and significant content changes.
...
- Add structured-data validation and schema opportunity reporting.
...
- Build a lead inbox with search, tags, and assignment.
